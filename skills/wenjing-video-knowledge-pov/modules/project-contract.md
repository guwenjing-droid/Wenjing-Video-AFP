...
沿用 MISSING/DRAFT/READY/APPROVED/LOCKED/STALE/BLOCKED、manifest/state、SHA-256、CR 与局部恢复规则。正式路径：`01_knowledge_truth_lock_LOCKED.md`、`02_knowledge_narrative_plan_LOCKED.md`、`03_script_LOCKED.md`。LOCKED 不静默覆盖。
